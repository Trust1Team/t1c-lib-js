...
describe('EMV Container', () => {
    ...
    describe(':: Application Data ::', function () {
        beforeEach(function () {
            mock.onGet('plugins/emv/123/application-data').reply(() => {
    ...
    describe(':: Applications ::', function () {
        beforeEach(function () {
            mock.onGet('plugins/emv/123/applications').reply(() => {
    ...
    describe(':: ICC Public Key Certificate ::', function () {
        beforeEach(function () {
            mock.onPost('plugins/emv/123/icc-public-key-certificate', { aid: 'A0000000048002' }).reply(() => {
    ...
    describe(':: Issuer Public Key Certificate ::', function () {
        beforeEach(function () {
            mock.onPost('plugins/emv/123/issuer-public-key-certificate', { aid: 'A0000000048008' }).reply(() => {
                return [ 200, { data: { data: 'base64data', exponent: 'base64exponent', remainder: 'base64remainder' }, success: true }];
            });
        });
