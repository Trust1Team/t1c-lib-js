...
describe('Mobib Container', () => {
    ...
    describe('cardIssuing', function () {
        beforeEach(function () {
            mock.onGet('plugins/mobib/123/card-issuing').reply(() => {
    ...
    describe('contracts', function () {
        beforeEach(function () {
            mock.onGet('plugins/mobib/123/contracts').reply(() => {
    ...
    describe('picture', function () {
        beforeEach(function () {
            mock.onGet('plugins/mobib/123/picture').reply(() => {
    ...
    describe('status', function () {
        beforeEach(function () {
            mock.onGet('plugins/mobib/123/status').reply(() => {
