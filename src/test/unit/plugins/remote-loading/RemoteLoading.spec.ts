...
describe('Remote Loading Container', () => {
    ...
    describe('can get a cards ATR', function () {
        beforeEach(function () {
            mock.onGet('plugins/readerapi/123/atr')
                .reply(config => {
    ...
    describe('can send bulk APDU calls', function () {
        beforeEach(function () {
            mock.onPost('plugins/readerapi/123/apdus', [{ cla: 'F1', ins: '95', p1: 'F7', p2: 'E4', data: 'FE0000040001300000' },
    ...
    describe('can retrieve CCID features of the reader', function () {
        beforeEach(function () {
            mock.onGet('plugins/readerapi/123/ccid-features')
                .reply(config => {
                    if (config.params && config.params['session-id'] && config.params['session-id'] === '123') {
                        return [ 200, { success: true, data: [{
    ...
    describe('can verify that a card is present', function () {
        beforeEach(function () {
            mock.onGet('plugins/readerapi/123/is-present')
                .reply(config => {
                    if (config.params && config.params['session-id'] && config.params['session-id'] === '123') {
