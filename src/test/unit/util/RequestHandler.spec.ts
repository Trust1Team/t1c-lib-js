...
import { RequestHandler } from "../../../scripts/util/RequestHandler";
...
describe("RequestHandler Utility", () => {
    ...
    describe("can determine the correct options/callback to use for a request with filter", function () {
        let optionsObject: { filters?: string[], parseCerts: boolean };

        beforeEach(() => {
            optionsObject = { filters: ["filter1", "filter2"], parseCerts: true };
        });
