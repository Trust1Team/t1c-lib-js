...
describe('Core Services', () => {
    ...
    describe('getConsent', () => {
        beforeEach(function () {
            mock.onPost('https://localhost:10443/consent').reply((config) => {
    ...
    describe('info', () => {
        beforeEach(function () {
            mock.onGet('https://localhost:10443/').reply(() => {
    ...
    describe('reader', () => {
        beforeEach(function () {
            mock.onGet('https://localhost:10443/card-readers/123').reply(() => {
    ...
    describe('readers', () => {
        beforeEach(function () {
            mock.onGet('https://localhost:10443/card-readers').reply((config) => {
