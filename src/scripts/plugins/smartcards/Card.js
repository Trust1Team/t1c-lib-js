...
// classes
var OptionalPin = /** @class */ (function () {
...
var AuthenticateOrSignData = /** @class */ (function (_super) {
...
var VerifyPinData = /** @class */ (function (_super) {
...
var ResetPinData = /** @class */ (function () {
...
var PinTryCounterData = /** @class */ (function () {
...
var GenericReaderContainer = /** @class */ (function (_super) {
    __extends(GenericReaderContainer, _super);
    function GenericReaderContainer(baseUrl, containerUrl, connection, reader_id, containerPrefix, runInUserSpace) {
        var _this = _super.call(this, baseUrl, containerUrl, connection, containerPrefix, runInUserSpace) || this;
        _this.baseUrl = baseUrl;
        _this.containerUrl = containerUrl;
        _this.connection = connection;
        _this.reader_id = reader_id;
        _this.containerPrefix = containerPrefix;
        _this.runInUserSpace = runInUserSpace;
        _this.CONTAINER_NEW_CONTEXT_PATH_IN_USERSPACE = '/agent/0';
        return _this;
    }
...
var GenericSmartCard = /** @class */ (function (_super) {
...
var GenericPinCard = /** @class */ (function (_super) {
...
var GenericCertCard = /** @class */ (function (_super) {
...
var GenericSecuredCertCard = /** @class */ (function (_super) {
