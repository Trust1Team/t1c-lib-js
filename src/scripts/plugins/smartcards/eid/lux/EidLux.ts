...
class EidLux extends GenericSecuredCertCard implements AbstractEidLUX {
    ...
    public biometric(callback?: (error: RestException, data: BiometricResponse) => void): Bluebird<BiometricResponse> {
    ...
    public picture(callback?: (error: RestException, data: PictureResponse) => void): Bluebird<PictureResponse> {
    ...
    public verifyPin(body: OptionalPin, callback?: (error: RestException, data: T1CResponse) => void | Bluebird<T1CResponse>) {
    ...
    public signData(body: AuthenticateOrSignData, callback?: (error: RestException, data: DataResponse) => void | Bluebird<DataResponse>) {
        return PinEnforcer.check(this.connection, this.baseUrl, this.reader_id, body.pin).then(() => {
            return this.connection.post(this.baseUrl,
    ...
    public signatureImage(callback?: (error: RestException, data: SignatureImageResponse) => void | Bluebird<SignatureImageResponse>) {
