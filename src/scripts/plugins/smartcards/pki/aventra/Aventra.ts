...
class Aventra extends GenericCertCard implements AbstractAventra {
    ...
    public verifyPin(body: VerifyPinData, callback?: (error: RestException, data: T1CResponse) => void): Bluebird<T1CResponse> {
    ...
    public resetPin(body: ResetPinData, callback?: (error: RestException, data: T1CResponse) => void): Bluebird<T1CResponse> {
