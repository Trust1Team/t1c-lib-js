...
class GCLClient {
    ...
    download(callback?: (error: RestException, data: DownloadLinkResponse) => void): Promise<{}>;
    dumpData(readerId: string, data: OptionalPin, callback?: (error: RestException, data: DataResponse) => void): Promise<DataResponse>;
    readersCanAuthenticate(callback?: (error: RestException, data: CardReadersResponse) => void): Promise<{}>;
    authenticate(readerId: string, data: AuthenticateOrSignData, callback?: (error: RestException, data: DataResponse) => void): Promise<{}>;
    readersCanSign(callback?: (error: RestException, data: CardReadersResponse) => void): Promise<{}>;
    sign(readerId: string, data: AuthenticateOrSignData, callback?: (error: RestException, data: DataResponse) => void): Promise<{}>;
    readersCanVerifyPin(callback?: (error: RestException, data: CardReadersResponse) => void): Promise<{}>;
    verifyPin(readerId: string, data: OptionalPin, callback?: (error: RestException, data: DataResponse) => void): Promise<{}>;
