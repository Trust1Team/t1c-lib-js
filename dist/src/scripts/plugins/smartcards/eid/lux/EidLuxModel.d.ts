...
export interface AbstractEidLUX extends CertCard {
    ...
    pinReset(body: LuxPinResetData, callback?: (error: RestException, data: T1CResponse) => void | Promise<T1CResponse>): any;
    pinChange(body: LuxPinChangeData, callback?: (error: RestException, data: T1CResponse) => void | Promise<T1CResponse>): any;
    pinUnblock(body: LuxPinUnblockData, callback?: (error: RestException, data: T1CResponse) => void | Promise<T1CResponse>): any;
}
