...
export interface AbstractPiv extends SecuredCertCard {
    ...
    allData(filters: string[], body: OptionalPin, callback?: (error: T1CLibException, data: PivAllDataResponse) => void): Promise<PivAllDataResponse>;
    allCerts(filters: string[], body: OptionalPin, callback?: (error: T1CLibException, data: PivAllCertsResponse) => void): Promise<PivAllCertsResponse>;
