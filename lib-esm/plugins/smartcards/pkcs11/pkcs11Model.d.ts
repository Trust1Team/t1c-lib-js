...
export interface AbstractPkcs11 {
    certificates(slotId: string, options?: Options, callback?: (error: RestException, data: Pkcs11CertificatesResponse) => void): Promise<Pkcs11CertificatesResponse>;
    ...
    token(slotId: string, callback?: (error: RestException, data: Pkcs11TokenResponse) => void): Promise<Pkcs11TokenResponse>;
...
export declare class Pkcs11SignData extends AuthenticateOrSignData {
    ...
    pin?: string;
    pace?: string;
    constructor(slot_id: string, cert_id: string, algorithm_reference: string, data: string, pin?: string, pace?: string);
}
export declare class Pkcs11VerifySignedData extends Pkcs11SignData {
    ...
    pin?: string;
    pace?: string;
    constructor(slot_id: string, cert_id: string, algorithm_reference: string, data: string, signature: string, pin?: string, pace?: string);
}
