...
var EidLux = (function (_super) {
    ...
    function EidLux(baseUrl, containerUrl, connection, reader_id, can) {
        ...
        _this.can = can;
        _this.can = PinEnforcer.encryptPin(can);
        return _this;
    }
    ...
    EidLux.prototype.rootCertificate = function (options, callback) {
        return this.getCertificateArray(EidLux.CERT_ROOT, RequestHandler.determineOptions(options, callback), undefined, EidLux.EncryptedCanHeader(this.can));
    };
    EidLux.prototype.authenticationCertificate = function (options, callback) {
        return this.getCertificate(EidLux.CERT_AUTHENTICATION, RequestHandler.determineOptions(options, callback), undefined, EidLux.EncryptedCanHeader(this.can));
    };
    EidLux.prototype.nonRepudiationCertificate = function (options, callback) {
        return this.getCertificate(EidLux.CERT_NON_REPUDIATION, RequestHandler.determineOptions(options, callback), undefined, EidLux.EncryptedCanHeader(this.can));
    };
    ...
    EidLux.prototype.getCertificate = function (certUrl, options, params, headers) {
        var self = this;
        return PinEnforcer.checkAlreadyEncryptedPin(this.connection, this.reader_id, this.can).then(function () {
            ...
            }, function (err) { return ResponseHandler.error(err, options.callback); });
        });
    };
