...
class MobibAllDataResponse extends CoreModel_1.DataObjectResponse {
...
class MobibStatusResponse extends CoreModel_1.DataObjectResponse {
    constructor(data, success) {
        super(data, success);
        this.data = data;
        this.success = success;
...
class MobibCardIssuingResponse extends CoreModel_1.DataObjectResponse {
    constructor(data, success) {
        super(data, success);
        this.data = data;
        this.success = success;
...
class MobibContractsResponse extends CoreModel_1.DataArrayResponse {
    constructor(data, success) {
        super(data, success);
        this.data = data;
        this.success = success;
