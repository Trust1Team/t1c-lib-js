...
var Isabel = (function (_super) {
    ...
    Isabel.prototype.rootCertificate = function (options, callback) {
        return this.getCertificate(Isabel.CERT_ROOT, __1.RequestHandler.determineOptions(options, callback));
    };
    Isabel.prototype.intermediateCertificate = function (options, callback) {
        return this.getCertificate(Isabel.CERT_INTERMEDIATE, __1.RequestHandler.determineOptions(options, callback));
    };
    Isabel.prototype.nonRepudiationCertificate = function (options, callback) {
        return this.getCertificate(Isabel.CERT_NON_REPUDIATION, __1.RequestHandler.determineOptions(options, callback));
    };
