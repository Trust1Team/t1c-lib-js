...
class PtAllCertsResponse extends CoreModel_1.DataObjectResponse {
...
class PtAllCerts {
    constructor(authentication_certificate, non_repudiation_certificate, root_authentication_certificate, root_certificate, root_non_repudiation_certificate) {
...
class PtAllDataResponse extends CoreModel_1.DataObjectResponse {
    constructor(data, success) {
        super(data, success);
        this.data = data;
        this.success = success;
...
class PtAllData {
    constructor(id, authentication_certificate, non_repudiation_certificate, root_authentication_certificate, root_certificate, root_non_repudiaton_certificate) {
        this.id = id;
        this.authentication_certificate = authentication_certificate;
        this.non_repudiation_certificate = non_repudiation_certificate;
        this.root_authentication_certificate = root_authentication_certificate;
...
class PtIdData {
    constructor(accidental_indications, civilian_number, country, date_of_birth, document_number, document_number_pan, document_type, document_version, gender, given_name_father, given_name_mother, health_no, height, issuing_entity, local_of_request, mrz1, mrz2, mrz3, name, nationality, raw_data, social_security_no, surname, surname_father, surname_mother, tax_no, validity_begin_date, validity_end_date, photo) {
...
class PtIdDataResponse extends CoreModel_1.DataObjectResponse {
    constructor(data, success) {
        super(data, success);
        this.data = data;
        this.success = success;
...
class PtAddressData {
    constructor(abbr_building_type, abbr_street_type, building_type, civil_parish, civil_parish_description, district, district_description, door_no, floor, gen_address_num, is_national, locality, municipality, municipality_description, place, postal_locality, raw_data, side, street_name, street_type, type, zip3, zip4) {
...
class PtAddressResponse extends CoreModel_1.DataObjectResponse {
    constructor(data, success) {
        super(data, success);
        this.data = data;
        this.success = success;
