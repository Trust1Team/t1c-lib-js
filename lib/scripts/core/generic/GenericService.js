...
const EidBe_1 = require("../../plugins/smartcards/eid/be/EidBe");
const ResponseHandler_1 = require("../../util/ResponseHandler");
const _ = require("lodash");
const CardUtil_1 = require("../../util/CardUtil");
const Aventra_1 = require("../../plugins/smartcards/pki/aventra/Aventra");
const SyncUtil_1 = require("../../util/SyncUtil");
class Arguments {
    ...
    static determineContainerForCard(args) {
        return new Promise((resolve, reject) => {
            if (args.reader && args.reader.card) {
                let container = CardUtil_1.CardUtil.determineContainer(args.reader.card);
                if (!container) {
