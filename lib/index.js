...
const Polyfills_1 = require("./scripts/util/Polyfills");
...
__export(require("./scripts/plugins/smartcards/pki/oberthur/Oberthur"));
__export(require("./scripts/plugins/smartcards/pki/oberthur/OberthurModel"));
